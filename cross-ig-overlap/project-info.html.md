...
canonical_url: https://ike.network/hl7-ig-corpus-example/cross-ig-overlap/project-info.html
---
...
| --- | --- |
| [About](index.html)[2] | Cross-IG analytic assembly — overlap, conflict, and value-set drift across ingested HL7 implementation guides. |
