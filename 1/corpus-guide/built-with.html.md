...
canonical_url: https://ike.network/hl7-ig-corpus-example/corpus-guide/built-with.html
---

# Built With

Open-source software that `corpus-guide` 1-SNAPSHOT depends on, links against, ships within, or invokes at runtime.
