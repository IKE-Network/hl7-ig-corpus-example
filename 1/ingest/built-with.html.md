...
canonical_url: https://ike.network/hl7-ig-corpus-example/ingest/built-with.html
---

# Built With

Open-source software that `ingest` 1-SNAPSHOT depends on, links against, ships within, or invokes at runtime.
