...
canonical_url: https://ike.network/hl7-ig-corpus-example/cross-ig-overlap/licenses.html
---

# Licenses (SPDX)

Licenses for declared dependencies of `cross-ig-overlap` 1-SNAPSHOT, grouped by SPDX expression. Rendered from `[bom.json](bom.json)[1]` (CycloneDX) at `pre-site` phase by `ike:render-spdx-licenses` (ike-issues#335).
