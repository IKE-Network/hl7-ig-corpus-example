...
canonical_url: https://ike.network/hl7-ig-corpus-example/us-core/licenses.html
---

# Licenses (SPDX)

Licenses for declared dependencies of `us-core` 1-SNAPSHOT, grouped by SPDX expression. Rendered from `[bom.json](bom.json)[1]` (CycloneDX) at `pre-site` phase by `ike:render-spdx-licenses` (ike-issues#335).
