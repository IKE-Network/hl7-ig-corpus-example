...
canonical_url: https://ike.network/hl7-ig-corpus-example/ingest/project-info.html
---
...
| --- | --- |
| [About](index.html)[2] | Java tool that converts HL7 IG-publisher output bundles into AsciiDoc topic fragments for ingestion into the corpus topic library. |
