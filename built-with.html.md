...
canonical_url: https://ike.network/hl7-ig-corpus-example/built-with.html
---

# Built With

Open-source software that `hl7-ig-corpus-example` 1-SNAPSHOT depends on, links against, ships within, or invokes at runtime.
